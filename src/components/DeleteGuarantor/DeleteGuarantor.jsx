    ...
    return (
       ...
       <ReactTooltip id='Deletar' place="bottom" type="dark" effect="solid">
        ...
        <div className="itensModal-Process">
          <div className="textModalGuarantor">
                  <IoCloseCircle />
                  <h3>Deseja deletar o {typeGuarantor}:</h3>
                  <h4>{name}</h4>
                  <h4>({fantasyName})</h4>
                  <h5>CPF/CNPJ: {cpfCnpj} | Endereço: {address}</h5>
          </div>
            <div className="buttons">
                    <button onClick={handleDeleteGuarantor}><IoTrashOutline/> Deletar</button>
