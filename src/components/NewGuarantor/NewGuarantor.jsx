...
export function NewGuarantor() {
    ...
    function handleOpenModalLocator(e) {
        ...
        function handleNewClient() {
            ...
            newGuarantor({idCompany, name: newName, fantasyName: newFantasyName, rg, cpf_Cnpj, birthday, email, phone, whatsapp, cep, road: newRoad, number, district: newDistrict, city: newCity, uf: uf.toUpperCase(),})
        }
    ...
    return (
        <>
         <button className="link" onClick={handleOpenModalLocator}>Novo fiador</button>
