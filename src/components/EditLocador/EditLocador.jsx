...
export function EditLocador({idLocator}) {
    ...
    useEffect(() => {
        async function loadGuarantor() {
            await api.get(`/locator/unic/${idLocator}`).then((res) => {
    ...
    function handleOpenModalLocator(e) {
        ...
        function handleNewClient() {
            updateLocador({id: idLocator, name: newName, fantasyName: newFantasyName, rg, cpf_Cnpj, birthday, email, phone, whatsapp, cep, road: newRoad, number, district: newDistrict, city: newCity, uf: uf.toUpperCase(),})
        }
