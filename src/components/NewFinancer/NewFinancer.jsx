...
import { MyButtonDocument } from "../../components/UploadDocuments/UploadDocuments";
         ...
         <Modal isOpen={isOpenModalSearch} onRequestClose={handleCloseModalSearch}
            ...
            <div className="itensModalHome-Search">
               <div className="form">
                    ...
                    <br />
                    <h5>Apenas um comprovante por transação</h5>
                    <MyButtonDocument uploadFiles2={uploadFiles2}/>
                    
                    {document !== "" ?
                    <>
                    <div className="documents">
                     <h5>Comprovante anexado:</h5>
                    <a href={document} target="_blank"><IoDocumentAttachOutline/>{nameDocument}</a>
                    </div>
                    </>
                    :""
                    }
