...
export function MyChargesProperty() {
    ...
    return (
        <div className="MyChargesProperty">
            <NavbarAdm />
            <ToolBar />
            <div className="aside">
            ...
            <div className="informations">
                ...
                {data.map((property) => {
                    return (
                        <div className="contracts" key={property.id}>
                            <div className="dataContracts">
                                ...
                                <div className="dataContractsUnic">
                                    <h6>ID Imóvel</h6>
                                    <h5>{property.idProperty}</h5>
                                </div>
                                <div className="dataContractsUnic">
                                    <h6>Cliente</h6>
                                    <h5>{property.nameClient}</h5>
                                </div>
                                <div className="dataContractsUnic">
                                    <h6>CPF</h6>
                                    <h5>{property.cpfClient}</h5>
                                </div>
                                <div className="dataContractsUnic">
                                    <h6>Data Início</h6>
                                    <h5>
                                        <DateFormat date={property.created_at} />
                                    </h5>
                                </div>
                                <div className="dataContractsUnic">
                                    <h6>Status</h6>
